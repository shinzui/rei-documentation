...
Define and manage custom properties that can be attached to entities (intentions, habits, disruptions, notes, journal entries). Custom properties allow you to extend entities with your own metadata fields.
